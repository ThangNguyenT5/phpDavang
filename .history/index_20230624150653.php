    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="swiper banner-slide">
                ...
                <div class="swiper-slide">
                    <div class="slide-img">
                        <img src="./assets/img/background_home.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slide-img">
                        <img src="./assets/img/background_home 2.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slide-img">
                        <img src="./assets/img/background_home 3.jpg" alt="">
                    </div>
                </div>
            ...
            <div id="commercial" class="grid wide">
                <!-- Service -->
                <div class="content__service-header col" data-aos="fade-up">
                ...
                <div class="content__service-project row">
                    ...
                    ?>
                    <div class="col l-3 m-4 c-6" data-aos="fade-up">
        ...
        <div class="footer grid">
            <div class="footer row">
                ...
                <div class="map col l-6 m-12 c-12" data-aos="zoom-out">
